...
import o.q.leidson.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "leidsonoliveira@yahoo.com.br", "36378912377",
				TipoCliente.PESSOAFISCA, pe.encode("1234"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Michele Oliveira", "michele@yahoo.com.br", "77118802000",
				TipoCliente.PESSOAFISCA, pe.encode("1234"));
